  ...
  <div class="quixnav">
    <div class="quixnav-scroll">
      <ul class="metismenu" id="menu">
        ...
        <li><a href="all-exam.php?Exams" aria-expanded="false"><i class="icon icon-globe-2"></i><span
              class="nav-text">All
              Exams</span></a></li>
        <li><a href="create-exam.php" aria-expanded="false"><i class="icon icon-globe-2"></i><span
              class="nav-text">Create a New Exam</span></a></li>
        <li><a href="all-exam.php?Given-Exams" aria-expanded="false"><i class="icon icon-globe-2"></i><span
